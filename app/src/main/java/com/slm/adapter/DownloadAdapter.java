...
public class DownloadAdapter extends BaseAdapter {
    ...
    public DownloadAdapter(Context context, List<ThreadInfo> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.download_list, null);
            ...
            final String fileName = threadInfo.getRemote_url().substring(threadInfo.getRemote_url().lastIndexOf("/") + 1);
            ...
            viewHolder.btCancel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("threadInfo", threadInfo);
                    context.startService(intent);
                    Toast.makeText(context, "下载任务关闭", Toast.LENGTH_SHORT).show();
                }
            });
